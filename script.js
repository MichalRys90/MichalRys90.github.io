$(document).ready(function() {
  const apiRoot = 'https://tasks-prod-kodilla-tasks-w9shb7.mo4.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://tasks-prod-kodilla-tasks-w9shb7.mo4.mogenius.io/v1/trello';
